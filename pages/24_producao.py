...
page_setup("Produção e Prontidão", allowed_roles=("ADMIN","CHEFIA"))
with session_scope() as s:
    ...
    if ready: st.success("Nenhuma falha crítica de configuração foi detectada pelo checklist automático.")
    else: st.error("Há falhas críticas. Não utilizar dados reais em produção até corrigi-las.")

...
def freeze_current_cycle(session,cycle_code: str,responsavel: str,code_version="0.4.1"):
    ...
    return freeze_cycle(cycle,hashes_bases=hashes,responsavel=responsavel,code_version=code_version,mcn_version=MCN_CONFIG.get("version","MCN"),ial_version=IAL_CONFIG.get("version","IAL"),config_version="0.4.1")
